...
class AutoruCarSpecLoader(ItemLoader):
    ...
    doors_in = Compose(select_spec, label='Количество дверей')
    seats_in = Compose(select_spec, label='Количество мест')
    ...
    transmission_in = Compose(select_spec, label='Коробка передач')
    gears_in = Compose(select_spec, label='Количество передач')
    ...
    front_brake_in = Compose(select_spec, label='Передние тормоза')
    rear_brake_in = Compose(select_spec, label='Задние тормоза')
    ...
    fuel_in = Compose(select_spec, label='Марка топлива')
    ...
    cylinders_in = Compose(select_spec, label='Количество цилиндров')
    ...
    cylinder_diameter_stroke_in = Compose(select_spec, label='Диаметр цилиндра и ход поршня, мм')
